# Predicting the proportion of ternary lithium batteries
import pandas as pd
...
# 预测 三元锂占比
def ptpoTernaryLithiumBatteries():
    ...
    # 数据路径
    file_path = './data.xls' 
    outfile_path = './out_ptpoTer.xls'
    
    # 列名称
    sales_name = "搭载三元锂电池汽车销量"
